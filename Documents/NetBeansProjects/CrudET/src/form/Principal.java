...
//            model=new DefaultTableModel(null,Titulos);   
            ...
            while (rs.next()) {
                persona[0] = rs.getInt("ID_registro");
                persona[1] = rs.getString("usuario");
                persona[2] = rs.getString("contraseña");
    ...
    void Agregar() {
        ...
        try {
            if (dni.equals("") || nom.equals("")) {
                ...
                String sql = "insert into regitro(ID_registro) values('" + dni + "','" + nom + "')";
                con = cn.getConnection();
                st = con.createStatement();
    ...
    void Modificar() {
        String dni = txtDNI.getText();
        String nom = txtNom.getText();
        String sql = "update registro set usuario='" + dni + "',contraseña='" + nom + "' where ID_cliente=" + id;
        try {
