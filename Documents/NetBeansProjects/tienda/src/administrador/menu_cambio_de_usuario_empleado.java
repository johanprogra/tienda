...
public class menu_cambio_de_usuario_empleado extends javax.swing.JFrame {

 
    public menu_cambio_de_usuario_empleado() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Bienvenido al menu empleado cambio de usuario y contraseña");
        ...
        jLabel22.setText("¿Que deseas hacer?");

        jLabel23.setBackground(new java.awt.Color(255, 255, 255));
        jLabel23.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jLabel23.setForeground(new java.awt.Color(255, 255, 255));
        jLabel23.setText("Ingresar nuevo usuario");

        jLabel24.setBackground(new java.awt.Color(255, 255, 255));
        jLabel24.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jLabel24.setForeground(new java.awt.Color(255, 255, 255));
        jLabel24.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel24.setText("cambiar usuario y contraseña");
    ...
    private void usuarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_usuarioActionPerformed
        usuario_nuevo_vendedor usuario1=new usuario_nuevo_vendedor();
         usuario1.setVisible(true);
         dispose();
    }//GEN-LAST:event_usuarioActionPerformed

    private void contraseñaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_contraseñaActionPerformed
        cambio_clave_vendedor clave=new cambio_clave_vendedor();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(menu_cambio_de_usuario_empleado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new menu_cambio_de_usuario_empleado().setVisible(true);
            }
        });
    }
