...
public class productos extends javax.swing.JFrame {
   ...
   auto.autocompletarproductos(buscar, result);
    ...
    private void devActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_devActionPerformed
        if(cambio.equals("uno")){
          asg="1";
          ventas ven=new ventas();
          ven.setVisible(true);
          dispose();
        }else if(cambio.equals("dos")){
          asg="1"; 
          menuvendedor menu=new menuvendedor();
          menu.setVisible(true);
          dispose();
      }else if(cambio.equals("tres")){
          asg="1"; 
          ventas_admin menu=new ventas_admin();
          menu.setVisible(true);
          dispose();
      }
