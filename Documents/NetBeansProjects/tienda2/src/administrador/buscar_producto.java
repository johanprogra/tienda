...
public static String dato="";
    ...
    private void initComponents() {
        ...
        categoria.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "..............", "cod_nit", "cod_productos", "nombre_producto", "precio", "talla", "color", "existencias" }));
        ...
        jLabel2.setText("Bienvenido al historial de productos");
        ...
        result.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id_nit", "cod_producto", "nombre_producto", "fecha"
            }
        ));
    ...
    auto.buscar_historial_producto(result, buscar, categoria, desde, hasta);
    }
    ...
    if(bu.equals("") || ca.equals("..............")){
     ...
     int i=JOptionPane.showConfirmDialog(null,"Deseas volver al historial productos","",JOptionPane.YES_NO_OPTION);
           if(i==0){
           act1="actualiza1";     
           autocompletar auto=new autocompletar();
