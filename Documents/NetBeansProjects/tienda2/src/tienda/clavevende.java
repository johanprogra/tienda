...
public class clavevende extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        contraseña1.setBounds(140, 70, 210, 30);
    ...
    private void ingresar2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ingresar2ActionPerformed
        ...
        if(usuari.equals("") || contraseña.equals("")){
         ...
         usu.Logguearse_vendedor(usuario1, contraseña1);
         if(cer.equals("abrir")){
