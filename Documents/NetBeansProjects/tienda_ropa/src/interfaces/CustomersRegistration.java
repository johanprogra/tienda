...
import functions.funtionCustomers;
...
public class CustomersRegistration extends javax.swing.JFrame {
    ...
    public CustomersRegistration() {
        ...
        ImageIcon imagen3=new ImageIcon(getClass().getResource("/images/dev.png"));
    ...
    personaDTOcustomers date=new personaDTOcustomers();
    
    date.setNombres(nombre.getText());
    date.setApellidos(apellido.getText());
    date.setTipo_documento((String) tipo_doc.getSelectedItem());
    date.setCedula(Integer.parseInt(n_documeto.getText()));
    date.setGenero((String) genero.getSelectedItem());
    date.setDireccion(direccion.getText());
    date.setCiudad(ciudad.getText());
    date.setObservacion(observacion.getText());
    date.setTelefono(Integer.parseInt(telefono.getText()));
    date.setCelular(Integer.parseInt(celular.getText()));
    
    PersonaDAOJDBCCustomers parameter=new PersonaDAOJDBCCustomers(n_documeto.getText());
    funtionCustomers funtion=new funtionCustomers();
    funtion.insert();
    funtion.dataUsedInsert(result);
