...
public class sales extends javax.swing.JFrame {
    ...
    public sales() {
        ...
        ImageIcon imagen2=new ImageIcon(getClass().getResource("/images/reg.png"));
        ImageIcon imagen3=new ImageIcon(getClass().getResource("/images/most.png"));
        ImageIcon imagen4=new ImageIcon(getClass().getResource("/images/reg.png"));
        ImageIcon imagen5=new ImageIcon(getClass().getResource("/images/dev.png"));
        ImageIcon imagen6=new ImageIcon(getClass().getResource("/images/buscaravanzada.png"));
        ImageIcon imagen7=new ImageIcon(getClass().getResource("/images/limpiar.png"));
        ImageIcon imagen8=new ImageIcon(getClass().getResource("/images/vent.png"));
    ...
    dispose();
    SearchEmployee serch=new SearchEmployee();
